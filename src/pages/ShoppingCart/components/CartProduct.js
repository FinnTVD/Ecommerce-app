...
const CartProduct = ({ handleClickCard }) => {
	...
	const { cartList, lengthShoppingCart } = useSelector(
...
const content = (cartList, navigate, dispatch, lengthShoppingCart) => {
	...
	const fiveAddNewProduct = cartList
		.slice(lengthShoppingCart - 5 <= 0 ? 0 : lengthShoppingCart - 5)
		.reverse();
